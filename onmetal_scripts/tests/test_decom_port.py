...
from onmetal_scripts import decom_port
from onmetal_scripts.tests import base

import mock


class TestDecomPort(base.BaseTest):
    def setUp(self):
        self.script = decom_port.DecomPort()

    @mock.patch('onmetal_scripts.decom_port.DecomPort.neutron_client')
    @mock.patch('onmetal_scripts.decom_port.DecomPort.ironic_client')
    def test_run_add(self, mock_ironic, mock_neutron):
        ...
        mock_neutron.add_decom_port.assert_called_with(test_node)
    ...
    def test_run_remove(self, mock_ironic, mock_neutron):
        ...
        mock_neutron.remove_decom_port.assert_called_with(test_node)
